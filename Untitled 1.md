            ...
            steps {
                ...
                if [[ ${params.need_build} == "true" ]];then
                    if [[ ${params.package_manager} == "npm" ]];then
                        ...
                        cd BMS && npm  install -g pnpm@7 --registry=https://registry.npmmirror.com && pnpm install && pnpm build
                    fi
                fi
                """
            }
            ...
            steps {
                ...
                if [[ ${params.need_build} == "true" ]];then
                    if [[ ${params.package_manager} == "npm" ]];then
                        ...
                        cd Front && npm  install -g pnpm@7 --registry=https://registry.npmmirror.com && pnpm install && pnpm build
                    fi
                fi
            ...
            steps {
                sh """
                    ...
                    if [ \"${params.restart_application}\" == \"true\" ]; then
                        ...
                        sleep 2
                        pods=`kubectl get pod -n ${NAMESPACE} wolf-static -l name=wolf-static | sed -e 1d | awk '{print \$1}'`
